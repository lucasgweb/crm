                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle text-sm">
                            <blockquote>Gestión de Modalidades</blockquote>
                        </div>
                    </div>
    ...
    <div class="container-fluid px-4 mt-n10">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col pb-3">
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#newUser">+ Agregar Modalidad</button>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newUserModalCenterTitle">Detalles de la Modalidad</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="card-body">
                <form method="post" action="">
                    <div class="mb-3">
                        <label class="small mb-1" for="input">Modalidad</label>
                        <input class="form-control" id="input" type="text" placeholder="Ingresar tipo" name="tipo" <?= $disabled ?> />
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                        <button class="btn btn-primary" type="submit" <?= $disabled ?>>Agregar Modalidad</button>
                    </div>
                    <!-- Submit button-->
                </form>
            </div>
