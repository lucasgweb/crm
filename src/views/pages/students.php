                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle text-sm">
                            <blockquote>Gestión de Alumnos</blockquote>
                        </div>
                    </div>
    ...
    <div class="container-fluid px-4 mt-n10">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col pb-3">
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#newUser">+ Agregar Alumno</button>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newUserModalCenterTitle">Detalles del Alumno</h5>
            ...
            <div class="card-body">
                <form method="post" action="">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputEmailAddress" type="text" placeholder="Ingresar nombre" name="name" <?= $disabled ?> />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputPassword" type="text" placeholder="Ingresar dirección" name="adress" <?= $disabled ?> />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="submit" <?= $disabled ?>>Agregar Alumno</button>
                    </div>
                    <!-- Submit button-->
                </form>
            </div>
